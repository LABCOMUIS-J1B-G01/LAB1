...
class punto_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "punto_3", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("punto_3")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 49e3, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 14e3, 1, 0, 0)
